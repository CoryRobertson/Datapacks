...
execute as @a[scores={deaths=3..}] at @s run function stuff:died

execute as @a[scores={deaths=3..}] at @s if entity @e[type=minecraft:item,distance=..1,nbt={Item:{id:"minecraft:diamond_block"}}] run function stuff:revive
